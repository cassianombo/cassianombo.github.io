    ...
    <section id="contact" className="py-20 px-8 bg-zinc-950">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <div className="flex items-center gap-3 bg-github-bg-secondary border border-github-border rounded-lg px-6 py-4 hover:border-accent/50 transition-colors w-full sm:w-[320px] justify-center">
            <svg
            ...
            <a
              ...
              className="text-github-text hover:text-accent transition-colors text-lg">
